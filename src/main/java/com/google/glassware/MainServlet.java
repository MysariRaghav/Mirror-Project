...
public class MainServlet extends HttpServlet {
    ...
    private static final String PAGINATED_HTML =
            "<article>\n" +
                    ...
                    "      <p class=\"yellow\">126 minutes to home</p><p>Medium traffic on Broadway</p>\n" +
                    "    </div>\n" +
                    "  </section>\n" +
                    "</article>";
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException {
        ...
        if (req.getParameter("operation").equals("insertSubscription")) {
        ...
        else if (req.getParameter("operation").equals("insertLocation")) {
            LOG.info("Inserting Timeline Location Item");
            TimelineItem timelineItem = new TimelineItem();
            ...
            try {
                ...
                l1.setLatitude(40.0377);
                l1.setLongitude(-75.3376);
                timelineItem.setLocation(l1);

                //location =timelineItem.getLocation();
                String locationText ="Location recorded on: " + location.getTimestamp() + "\n" +
                ...
                String html ="<article>\n" +
                        "            <figure>\n" +
                        "            <img src=\"glass://map?w=240&h=360&marker=0;"+location.getLatitude() +","+location.getLongitude() +
                        "            \"height=\"360\" width=\"240\">\n" +
                        "            </figure>\n" +
                        "            <section>\n" +
                        "            <div class=\"text-auto-size\">\n" +
                        "            <p class=\"yellow\">"+locationText +"</p>\n" +
                        "            </div>\n" +
                        "            </section>\n" +
                        "            </article>";
                ...
                menuItemList.add(new MenuItem().setAction("CUSTOM").setPayload("exampleprotocol://").setValues(values));
                timelineItem.setMenuItems(menuItemList);
                   ...
                   /* <article>
            <figure>
            <img src="glass://map?w=240&h=360&marker=0;"+location.getLatitude() +","+location.getLatitude()
            height="360" width="240">
            </figure>
            <section>
            <div class="text-auto-size">
            ...
            /*LOG.info("Location recorded on: " + location.getTimestamp());
            LOG.info("  > Lat: " + location.getLatitude());
            LOG.info("  > Long: " + location.getLongitude());
            LOG.info("  > Accuracy: " + location.getAccuracy() + " meters");*/
            } catch (IOException e) {
            ...
            message = "A timeline Location item has been inserted.";
